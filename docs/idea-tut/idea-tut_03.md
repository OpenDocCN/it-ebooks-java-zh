...
> *   更多信息可以阅读：[`www.jetbrains.com/idea/download/system_requirements.jsp?os=win`](https://www.jetbrains.com/idea/download/system_requirements.jsp?os=win)

## 首次安装

> *   IntelliJ IDEA 的安装是非常简单的，不需要做过多的选择，可以说简单到都是 `Next` 即可。

![首次安装步骤截图](img/iii-a-first-install-1.jpg)

**图片 3.1** 首次安装步骤截图

![首次安装步骤截图](img/iii-a-first-install-2.jpg)

**图片 3.2** 首次安装步骤截图

![首次安装步骤截图](img/iii-a-first-install-3.jpg)

**图片 3.3** 首次安装步骤截图

![首次安装步骤截图](img/iii-a-first-install-4.jpg)
...
![首次安装步骤截图](img/iii-a-first-install-5.jpg)

**图片 3.5** 首次安装步骤截图

![首次安装步骤截图](img/iii-a-first-install-6.jpg)

**图片 3.6** 首次安装步骤截图

![首次安装步骤截图](img/iii-a-first-install-7.jpg)
...
![已有旧版本安装新版本步骤截图](img/iii-b-repeatedly-install-1.jpg)

**图片 3.8** 已有旧版本安装新版本步骤截图

![已有旧版本安装新版本步骤截图](img/iii-b-repeatedly-install-2.jpg)
...
![已有旧版本安装新版本步骤截图](img/iii-b-repeatedly-install-3.jpg)
...
![卸载](img/iii-c-uninstall-1.jpg)

**图片 3.11** 卸载

![卸载](img/iii-c-uninstall-2.jpg)

**图片 3.12** 卸载

![卸载](img/iii-c-uninstall-3.jpg)
