...
由于 IntelliJ IDEA 官网在亚洲没有设服务器，且官网用到一些类似 Twitter、Facebook 等站的脚本会使得你在国内出现访问巨慢或是不允许访问的特殊情况，所以建议你在访问官网、访问插件库、小版本本地迭代更新等操作的时候出现奇怪问题的时候，请自备 VPN 等网络加速工具。
...
> *   申请免费版本：[`www.jetbrains.com/idea/buy/`](https://www.jetbrains.com/idea/buy/)
> *   旗舰版和社区版差异细节：[`www.jetbrains.com/idea/features/editions_comparison_matrix.html`](https://www.jetbrains.com/idea/features/editions_comparison_matrix.html)
...
> *   IntelliJ IDEA 官网博客：[`eap.jetbrains.com/idea`](http://eap.jetbrains.com/idea)