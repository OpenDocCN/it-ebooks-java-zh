...
![IntelliJ IDEA 下的版本控制介绍](img/xvi-a-version-control-system-introduce-1.jpg)
...
> *   Subversion 官网下载：[`subversion.apache.org/download/#recommended-release`](https://subversion.apache.org/download/#recommended-release)
> *   TortoiseSVN 官网下载：[`tortoisesvn.net/downloads.zh.html`](http://tortoisesvn.net/downloads.zh.html)

![SVN 的使用](img/xvi-b-version-control-system-svn-introduce-1.jpg)

**图片 16.2** SVN 的使用

> *   如上图箭头所示，在安装 TortoiseSVN 的时候，默认 `command line client tools`，是不安装的，这里建议勾选上。

![SVN 的使用](img/xvi-b-version-control-system-svn-introduce-2.jpg)
...
> *   Git 官网下载：[`git-scm.com/`](http://git-scm.com/)
> *   TortoiseGit 官网下载：[`download.tortoisegit.org/tgit/`](http://download.tortoisegit.org/tgit/)

![Git 的使用](img/xvi-c-version-control-system-git-introduce-1.jpg)
...
![Github 的使用](img/xvi-d-version-control-system-github-introduce-1.jpg)

**图片 16.5** Github 的使用

> *   如上图标注 1 所示，填写你的 Github 登录账号和密码，点击 `Test` 可以进行测试是否可以正确连上。

![Github 的使用](img/xvi-d-version-control-system-github-introduce-2.jpg)

**图片 16.6** Github 的使用

> *   如上图标注 1 所示，支持直接从你当前登录的 Github 账号上 Checkout 项目。

![Github 的使用](img/xvi-d-version-control-system-github-introduce-3.jpg)

**图片 16.7** Github 的使用

> *   如上图标注 1 所示，支持把当前本地项目分享到你的 Github 账号上。

![Github 的使用](img/xvi-d-version-control-system-github-introduce-4.jpg)

**图片 16.8** Github 的使用

> *   如上图标注 1 所示，支持创建 `Gist`。Github 的 Gist 官网地址：[`gist.github.com/`](https://gist.github.com/)

## 版本控制主要操作按钮

![版本控制主要操作按钮](img/xvi-e-version-control-system-operation-introduce-1.jpg)

**图片 16.9** 版本控制主要操作按钮

> *   如上图标注 1 所示，对目录进行右键弹出的菜单选项。

![版本控制主要操作按钮](img/xvi-e-version-control-system-operation-introduce-2.jpg)

**图片 16.10** 版本控制主要操作按钮

> *   如上图标注 1 所示，对文件进行右键弹出的菜单选项。

![版本控制主要操作按钮](img/xvi-e-version-control-system-operation-introduce-3.jpg)
...
![版本控制主要操作按钮](img/xvi-e-version-control-system-operation-introduce-4.jpg)
...
![版本控制相关的常用设置说明](img/xvi-f-version-control-system-settings-introduce-1.jpg)
...
![版本控制相关的常用设置说明](img/xvi-f-version-control-system-settings-introduce-2.jpg)
...
![版本控制相关的常用设置说明](img/xvi-f-version-control-system-settings-introduce-3.jpg)
...
![版本控制相关的常用设置说明](img/xvi-f-version-control-system-settings-introduce-4.jpg)
...
![版本控制相关的常用设置说明](img/xvi-f-version-control-system-settings-introduce-5.jpg)
...
![SVN 的使用](img/xvi-g-svn-feature-1.jpg)
...
![SVN 的使用](img/xvi-g-svn-feature-2.jpg)
